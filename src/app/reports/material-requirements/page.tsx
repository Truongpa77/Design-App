...
import MaterialReqClient from './MaterialReqClient';
import pool from '@/lib/db';

export default async function MaterialRequirementsReportPage() {
  ...
  // Lấy danh sách báo giá phục vụ bộ lọc
  let quotations = [];
  try {
    const qListQuery = `
  ...
  return (
    <MainLayout user={user} title="Báo cáo Nhu cầu Vật tư">
      <MaterialReqClient initialQuotations={quotations} />
    </MainLayout>
  );
}
