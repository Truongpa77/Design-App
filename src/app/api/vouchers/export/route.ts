...
// GET - Lay danh sach phieu xuat kho
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (!finalDocNo) {
      ...
      finalDocNo = `PX${String(numRes.rows[0].next_num).padStart(4, '0')}`;
    }
    ...
    const docRes = await client.query(
      `INSERT INTO warehouse_documents 
       ...
       VALUES ($1, 'export', $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
